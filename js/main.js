...
document.addEventListener('DOMContentLoaded', () => {
    ...
    seriesSelect.addEventListener('change', (e) => {
        ...
        // update image smoothly (disabled to keep the premium Plan Canje visual)
        /*
